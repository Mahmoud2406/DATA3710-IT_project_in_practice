<?php
/**
 * Class for creating readable color schemes
 *
 * @package Styleguide
 */
...
class CSS_Color {
	...
	// store complementary colors based upon initial values
	var $bgc = '';
	var $fgc = '';
	...
	/**
	 * get a complementary color from a given hex value
	 */
